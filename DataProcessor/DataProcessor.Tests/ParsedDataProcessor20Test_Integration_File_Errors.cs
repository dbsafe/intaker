...
{
    [TestClass]
    public class ParsedDataProcessor20Test_Integration_File_Errors
    {
        ...
        {
            var fileDataSourceValidFile = TestHelpers.CreateFileDataSource<ParserContext20>("balance-missing-header.20.csv", false);
