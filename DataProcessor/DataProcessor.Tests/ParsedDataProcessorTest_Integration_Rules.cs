...
namespace DataProcessor.Tests
{
    ...
    public class ParsedDataProcessorTest_Integration_Rules
    {
        ...
        public void Process_Given_a_rule_violation_Result_should_indicate_the_error()
        {
            ...
            Assert.AreEqual(ValidationResultType.Critical, actual.Header.Fields[3].ValidationResult);
            ...
            Assert.AreEqual(ValidationResultType.Critical, actual.Trailer.ValidationResult);
            Assert.AreEqual(ValidationResultType.Warning, actual.Trailer.Fields[1].ValidationResult);
            Assert.AreEqual(ValidationResultType.Critical, actual.Trailer.Fields[2].ValidationResult);
