...
namespace DataProcessor.Decoders.Tests
{
    ...
    public class DateDecoderTest
    {
        ...
        public void Decode_Given_that_property_pattern_is_not_set_Should_throw_an_exception()
        {
            ...
            var target = new DateDecoder { FailValidationResult = ValidationResultType.InvalidFixable };
        ...
        {
            var field = new Field { Raw = "2020-10-20" };
            var target = new DateDecoder { Pattern = "yyyy-MM-dd", FailValidationResult = ValidationResultType.InvalidFixable };
